...
namespace eastl {
    ...
    namespace internal {
        ...
        public:
            ...
            class function_manager_base<Functor,
...
#define EASTL_INTERNAL_FUNCTION_VALID_FUNCTION_ARGS(FUNCTOR, RET, ARGS, BASE, MYSELF)                                                 \
    typename eastl::enable_if_t<eastl::is_invocable_r_v<RET, FUNCTOR, ARGS> && !eastl::is_base_of_v<BASE, eastl::decay_t<FUNCTOR>> && \
    ...
    EASTL_INTERNAL_FUNCTION_VALID_FUNCTION_ARGS(FUNCTOR, RET, ARGS, MYSELF, MYSELF)
        ...
        public:
            ...
            void swap(function_detail& other) EA_NOEXCEPT {
                ...
                if (HaveManager()) {
                    (void)(*mMgrFuncPtr)(
                        static_cast<void*>(&other.mStorage), static_cast<void*>(&mStorage), Base::ManagerOperations::MGROPS_MOVE_FUNCTOR);
                }

                if (other.HaveManager()) {
                    (void)(*other.mMgrFuncPtr)(
                        static_cast<void*>(&mStorage), static_cast<void*>(&tempStorage), Base::ManagerOperations::MGROPS_MOVE_FUNCTOR);
                }
            ...
            Functor* target() EA_NOEXCEPT {
                if (HaveManager() && target_type() == typeid(Functor)) {
                    void* ret = (*mMgrFuncPtr)(static_cast<void*>(&mStorage), nullptr, Base::ManagerOperations::MGROPS_GET_FUNC_PTR);
        ...
        private:
            ...
            void Destroy() EA_NOEXCEPT {
                if (HaveManager()) {
                    (void)(*mMgrFuncPtr)(static_cast<void*>(&mStorage), nullptr, Base::ManagerOperations::MGROPS_DESTRUCT_FUNCTOR);
                }
            }
            ...
            void Move(function_detail&& other) {
                if (other.HaveManager()) {
                    (void)(*other.mMgrFuncPtr)(
                        static_cast<void*>(&mStorage), static_cast<void*>(&other.mStorage), Base::ManagerOperations::MGROPS_MOVE_FUNCTOR);
                }
