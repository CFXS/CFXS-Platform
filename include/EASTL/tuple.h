...
namespace eastl {
    ...
    template<size_t I, typename Indices, typename... Ts>
    class tuple_element<I, const volatile Internal::TupleImpl<Indices, Ts...>> : public tuple_element<I, const volatile tuple<Ts...>> {};
    ...
    struct tuple_index<T, TupleTypes<T, TsRest...>> {
        ...
        static_assert(
            is_void<typename tuple_index<T, TupleTypes<TsRest...>>::DuplicateTypeCheck>::value,
    ...
    namespace Internal {
        ...
        struct MakeTupleTypesImpl<TupleTypes<Types...>, Tuple, Start, End> {
            ...
            typedef typename MakeTupleTypesImpl<TupleTypes<Types...,
        ...
        using MakeTupleTypes_t =
            typename MakeTupleTypesImpl<TupleTypes<>, Tuple, 0, tuple_size<typename remove_reference<Tuple>::type>::value>::type;
        ...
        struct TupleImplicitlyConvertible
            : public TupleImplicitlyConvertibleImpl<tuple_size<TargetTupleType>::value == sizeof...(FromTypes),
                                                    MakeTupleTypes_t<TargetTupleType>,
                                                    FromTypes...>::type {};
    ...
    public:
        ...
        EA_CONSTEXPR tuple(U&& u, Us&&... us) :
            mImpl(make_index_sequence<sizeof...(Us) + 1>{},
                  Internal::MakeTupleTypes_t<tuple>{},
                  eastl::forward<U>(u),
                  eastl::forward<Us>(us)...) {
        }
        ...
        template<typename OtherTuple, typename enable_if<Internal::TupleConvertible<OtherTuple, tuple>::value, bool>::type = false>
        tuple(OtherTuple&& t) : mImpl(eastl::forward<OtherTuple>(t)) {
        }

        template<typename OtherTuple, typename enable_if<Internal::TupleAssignable<tuple, OtherTuple>::value, bool>::type = false>
    ...
    EA_CONSTEXPR decltype(auto) apply(F&& f, Tuple&& t) {
        return detail::apply_impl(
            eastl::forward<F>(f), eastl::forward<Tuple>(t), make_index_sequence<tuple_size_v<remove_reference_t<Tuple>>>{});
    }
