 ...
 */
__STATIC_INLINE void __NVIC_EnableIRQ(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
        __COMPILER_BARRIER();
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32_t __NVIC_GetEnableIRQ(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE void __NVIC_DisableIRQ(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32_t __NVIC_GetPendingIRQ(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE void __NVIC_SetPendingIRQ(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE void __NVIC_ClearPendingIRQ(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32_t __NVIC_GetActive(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
 ...
 */
__STATIC_INLINE void __NVIC_SetPriority(int IRQn, uint32_t priority) {
    if ((int32_t)(IRQn) >= 0) {
 ...
 */
__STATIC_INLINE uint32_t __NVIC_GetPriority(int IRQn) {
    if ((int32_t)(IRQn) >= 0) {
 ...
 */
__STATIC_INLINE void __NVIC_SetVector(int IRQn, uint32_t vector) {
 ...
 */
__STATIC_INLINE uint32_t __NVIC_GetVector(int IRQn) {
    uint32_t *vectors = (uint32_t *)SCB->VTOR;
